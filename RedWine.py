...
# Groupinf=g thw wine vased on grade
...
# Checking one more for column names
red_wine_data.columns
...
# 1. # 1. Using Random Forest Classifier
...
# Train the LCassifier/fitting the model 
...
acc = []   # All Algorithms/model accuracies
names = []    # All model name

for name, model in models:

  acc_of_model = cross_val_score(model, X_train, y_train, cv = kf, scoring = 'accuracy')  # KFolds = 5 without shuffleing

  acc.append(acc_of_model)   # appending accuracy of different model to acc list

  names.append(names)   #   appendinfg name of models
